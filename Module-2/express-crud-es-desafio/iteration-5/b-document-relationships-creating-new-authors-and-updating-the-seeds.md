...
```html
<!-- author-add.hbs -->
<form action="/ruta" method="//método">
...
Debemos importar el Model Autor a routes/index.js
...
//renderizar author-add  
});

router.post('/authors/add', (req, res, next) => {
  const { ... } = ...;
  const newAuthor = new Author({ ... })
  //guardar en la base de datos el nuevo autor y una vez guardado redirigir a /books
